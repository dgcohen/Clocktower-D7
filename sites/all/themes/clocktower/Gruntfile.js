  ...
  grunt.initConfig({
    ...
    sprite:{
      all: {
        ...
        // why.
        imgPath         : '/sites/all/themes/custom/clocktower/images/generated/sprite-' + spritecachebust + '.png',
    ...
    sass: {
      ...
      dev : {
        options : { },
        files: {
          'css/clocktower.hacks.css'    : 'sass/clocktower.hacks.scss',
          'css/clocktower.no-query.css' : 'sass/clocktower.no-query.scss',
          'css/clocktower.normalize.css': 'sass/clocktower.normalize.scss',
          'css/clocktower.styles.css'   : 'sass/clocktower.styles.scss'
        }
      },
      dist : {
        options : {
